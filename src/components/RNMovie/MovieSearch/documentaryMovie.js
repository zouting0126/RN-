...
import DocumentaryMovieStars from './Stars/DocumentaryMovieStars'
...
class documentaryMovie extends React.Component {
    constructor(props) {
        super(props)
    ...
    getMoviesByPage = () => {
     ...
     // console.log(this.state.pageSize)
        ...
        const url = `http://t.yushu.im/v2/movie/search?tag=记录&start=${start}&count=${this.state.pageSize}`
              ...
              <View style={{ flexDirection: 'row', padding: 8 }}>
                ...
                <View style={{ justifyContent: 'space-around', width: '70%',}}>
                   ...
                   <View style={{flexDirection:'row'}}>
                    <DocumentaryMovieStars rating={item.rating.average}></DocumentaryMovieStars>

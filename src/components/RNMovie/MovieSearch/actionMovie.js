...
import ActionMovieStars from './Stars/ActionMovieStars'
...
class actionMovie extends React.Component {
    constructor(props) {
        super(props)
    ...
    getMoviesByPage = () => {
     ...
     // console.log(this.state.pageSize)
        ...
        const url = `http://t.yushu.im/v2/movie/search?tag=动作&start=${start}&count=${this.state.pageSize}`
             ...
             <View style={{ flexDirection: 'row', padding: 8 }}>
                ...
                <View style={{ justifyContent: 'space-around', width: '70%',}}>
                   ...
                   <View style={{flexDirection:'row',marginTop:5}}>
                    ...
                    <ActionMovieStars rating={item.rating.average}></ActionMovieStars>

...
import CartoonMovieStars from './Stars/CartoonMovieStars'
...
class cartoonMovie extends React.Component {
    ...
    getMoviesByPage = () => {
     ...
     // console.log(this.state.pageSize)
        ...
        const url = `http://t.yushu.im/v2/movie/search?tag=动漫&start=${start}&count=${this.state.pageSize}`
            ...
            <View style={{ flexDirection: 'row', padding: 8 }}>
                ...
                <View style={{ justifyContent: 'space-around', width: '70%',}}>
                   ...
                   <View style={{flexDirection:'row'}}>
                    <CartoonMovieStars rating={item.rating.average}></CartoonMovieStars>

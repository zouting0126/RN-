...
import CrimeMovieStars from './Stars/CrimeMovieStars'
...
class crimeMovie extends React.Component {
    constructor(props) {
        super(props)
    ...
    getMoviesByPage = () => {
     ...
     // console.log(this.state.pageSize)
        ...
        const url = `http://t.yushu.im/v2/movie/search?tag=犯罪&start=${start}&count=${this.state.pageSize}`
           ...
           <View style={{ flexDirection: 'row', padding: 8 }}>
                ...
                <View style={{ justifyContent: 'space-around', width: '70%',}}>
                   ...
                   <View style={{flexDirection:'row'}}>
                       {/* <Text><Text style={{color:'#ffb518',fontSize:20}}>★★★✰✰</Text></Text> */}
                    <CrimeMovieStars rating={item.rating.average}></CrimeMovieStars>

...
import TechnologyMovieStars from './Stars/TechnologyMovieStars'
...
class technologyMovie extends React.Component {
    constructor(props) {
        super(props)
    ...
    getMoviesByPage = () => {
     ...
     // console.log(this.state.pageSize)
        ...
        const url = `http://t.yushu.im/v2/movie/search?tag=科技&start=${start}&count=${this.state.pageSize}`
            ...
            <View style={{ flexDirection: 'row', padding: 8 }}>
                ...
                <View style={{ justifyContent: 'space-around', width: '70%',}}>
                   ...
                   <View style={{flexDirection:'row'}}>
                       {/* <Text><Text style={{color:'#ffb518',fontSize:20}}>★★★✰✰</Text></Text> */}
                    <TechnologyMovieStars rating={item.rating.average}></TechnologyMovieStars>

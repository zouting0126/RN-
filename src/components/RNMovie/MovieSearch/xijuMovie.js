...
import XiJuMovieStars from './Stars/XiJuMovieStars'
...
class xijuMovie extends React.Component {
    constructor(props) {
        super(props)
            ...
            <View style={{ flexDirection: 'row', padding: 8}}>
                ...
                <View style={{ justifyContent: 'space-around', width: '70%',}}>
                   ...
                   <View style={{flexDirection:'row'}}>
                    <XiJuMovieStars rating={item.rating.average}></XiJuMovieStars>
